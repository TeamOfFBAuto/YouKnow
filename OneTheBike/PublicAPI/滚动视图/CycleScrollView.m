...
- (id)initWithFrame:(CGRect)frame animationDuration:(NSTimeInterval)animationDuration WithTitleArray:(NSMutableArray *)titleArray
{
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView * title_backView = [[UIView alloc] initWithFrame:CGRectMake(0,self.frame.size.height-30,self.frame.size.width,20)];
        ...
        pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(200,0,100,20)];
...
- (void)setScrollViewContentDataSource
{
    ...
    {
        title_label.text = [self.title_array objectAtIndex:_currentPageIndex];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if(contentOffsetX >= (2 * CGRectGetWidth(scrollView.frame))) {
        ...
        title_label.text = [self.title_array objectAtIndex:self.currentPageIndex];
        [self configContentViews];
    }
    if(contentOffsetX <= 0) {
        self.currentPageIndex = [self getValidNextPageIndexWithPageIndex:self.currentPageIndex - 1];
